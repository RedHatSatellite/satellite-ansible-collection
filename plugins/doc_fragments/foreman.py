...
options:
  ...
  oauth1_consumer_key:
    description:
      ...
      - If the value is not specified in the task, the value of environment variable C(SATELLITE_OAUTH1_CONSUMER_KEY) will be used instead.
    required: false
    type: str
  oauth1_consumer_secret:
    description:
      - OAuth1 consumer secret for accessing the Foreman server.
      - If the value is not specified in the task, the value of environment variable C(SATELLITE_OAUTH1_CONSUMER_SECRET) will be used instead.
    required: false
    type: str
  validate_certs:
    description:
...
options:
  ...
  content_source:
    description:
      - Content Source (Capsule with Content) name.
